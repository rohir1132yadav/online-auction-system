        ...
        <div className="bg-white rounded-sm shadow-sm p-8">
          ...
          <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
            ...
            <section>
              ...
              <p>
                This project has been created by <strong>Rohit Yadav</strong>{" "}
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-sm">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <a
                      href="https://github.com/rohir1132yadav"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                      github.com/rohir1132yadav
                    </a>
                  </p>
                  <p>
                    <span className="font-medium">Project Repository:</span>{" "}
                    <a
                      href="https://github.com/rohir1132yadav/online-auction-system"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                      github.com/rohir1132yadav/online-auction-system
                    </a>
                  </p>
                </div>
              </div>
